Public Class ClassTreeViewColumns
    ...
    Private Sub ClassTreeViewColumns_Layout(sender As Object, e As EventArgs) Handles Me.Layout
        UpdateTreeViewWidth()
    End Sub
    ...
    Private Sub UpdateTreeViewWidth()
        Dim iMinWidthTotal As Integer = Me.Width
        Dim iCoumnWidthTotal As Integer = 0
        For Each mItem As ColumnHeader In ListView1.Columns
            iCoumnWidthTotal += mItem.Width
        Next

        If (iCoumnWidthTotal > iMinWidthTotal) Then
            TreeView1.Width = iCoumnWidthTotal
        Else
            TreeView1.Width = iMinWidthTotal
        End If
    End Sub
