...
#End Region
    ...
    Class ClassSettings
        ...
        Class STRUC_MISC_SETTINGS
            ...
            Private g_bEnableManualVelocity As Boolean = False
            ...
            Property m_EnableManualVelocity As Boolean
                Get
                    Return g_bEnableManualVelocity
                End Get
                Set(value As Boolean)
                    g_bEnableManualVelocity = value
                End Set
            End Property
            ...
            SyncLock g_mThreadLock
                ...
                Using mStream As New IO.FileStream(ClassConfigConst.PATH_CONFIG_VMT, IO.FileMode.OpenOrCreate, IO.FileAccess.ReadWrite)
                    Using mIni As New ClassIni(mStream)
                        ...
                        g_mMiscSettings.m_EnableManualVelocity =
                            (mIni.ReadKeyValue("MiscSettings", "EnableManualVelocity", "false") = "true")
                    ...
                    Using mIni As New ClassIni(mStream)
                        If ((iSaveFlags And ENUM_SETTINGS_SAVE_TYPE_FLAGS.DEVICE_RECENTER) <> 0 OrElse (iSaveFlags And ENUM_SETTINGS_SAVE_TYPE_FLAGS.ALL) <> 0) Then
                            For Each mItem In m_ControllerSettings.m_ControllerRecenter
                                mIni.WriteKeyValue(CStr(mItem.Key), "Recenter.X", mItem.Value.X.ToString(Globalization.CultureInfo.InvariantCulture))
                                mIni.WriteKeyValue(CStr(mItem.Key), "Recenter.Y", mItem.Value.Y.ToString(Globalization.CultureInfo.InvariantCulture))
                                mIni.WriteKeyValue(CStr(mItem.Key), "Recenter.Z", mItem.Value.Z.ToString(Globalization.CultureInfo.InvariantCulture))
                                mIni.WriteKeyValue(CStr(mItem.Key), "Recenter.W", mItem.Value.W.ToString(Globalization.CultureInfo.InvariantCulture))
                            Next
                        End If

                        If ((iSaveFlags And ENUM_SETTINGS_SAVE_TYPE_FLAGS.DEVICE) <> 0 OrElse (iSaveFlags And ENUM_SETTINGS_SAVE_TYPE_FLAGS.ALL) <> 0) Then
                            mIni.WriteKeyValue("ControllerSettings", "HtcTouchpadShortcutBinding", If(m_ControllerSettings.m_HtcTouchpadShortcutBinding, "true", "false"))
                            mIni.WriteKeyValue("ControllerSettings", "HtcTouchpadShortcutTouchpadClick", If(m_ControllerSettings.m_HtcTouchpadShortcutTouchpadClick, "true", "false"))
                            mIni.WriteKeyValue("ControllerSettings", "HtcTouchpadEmulationClickMethod", CStr(CInt(m_ControllerSettings.m_HtcTouchpadEmulationClickMethod)))
                            mIni.WriteKeyValue("ControllerSettings", "HtcGripButtonMethod", CStr(CInt(m_ControllerSettings.m_HtcGripButtonMethod)))
                            mIni.WriteKeyValue("ControllerSettings", "OculusButtonMethod", CStr(CInt(m_ControllerSettings.m_OculusButtonMethod)))
                            mIni.WriteKeyValue("ControllerSettings", "OculusGripToggle", If(m_ControllerSettings.m_OculusGripToggle, "true", "false"))
                            mIni.WriteKeyValue("ControllerSettings", "HybridGripToggle", If(m_ControllerSettings.m_HybridGripToggle, "true", "false"))
                            mIni.WriteKeyValue("ControllerSettings", "ControllerJoystickMethod", CStr(CInt(m_ControllerSettings.m_ControllerJoystickMethod)))
                            mIni.WriteKeyValue("ControllerSettings", "EnableControllerRecenter", If(m_ControllerSettings.m_EnableControllerRecenter, "true", "false"))
                            mIni.WriteKeyValue("ControllerSettings", "ControllerRecenterMethod", CStr(CInt(m_ControllerSettings.m_ControllerRecenterMethod)))
                            mIni.WriteKeyValue("ControllerSettings", "ControllerRecenterFromDeviceName", m_ControllerSettings.m_ControllerRecenterFromDeviceName)
                            mIni.WriteKeyValue("ControllerSettings", "EnableHmdRecenter", If(m_ControllerSettings.m_EnableHmdRecenter, "true", "false"))
                            mIni.WriteKeyValue("ControllerSettings", "HmdRecenterMethod", CStr(CInt(m_ControllerSettings.m_HmdRecenterMethod)))
                            mIni.WriteKeyValue("ControllerSettings", "HmdRecenterFromDeviceName", m_ControllerSettings.m_HmdRecenterFromDeviceName)
                            mIni.WriteKeyValue("ControllerSettings", "RecenterButtonTimeMs", CStr(m_ControllerSettings.m_RecenterButtonTimeMs))
                            mIni.WriteKeyValue("ControllerSettings", "OscThreadSleepMs", CStr(m_ControllerSettings.m_OscThreadSleepMs))
                            mIni.WriteKeyValue("ControllerSettings", "OscMaxThreadFps", CStr(m_ControllerSettings.m_OscMaxThreadFps))
                            mIni.WriteKeyValue("ControllerSettings", "ControllerJoystickAreaCm", m_ControllerSettings.m_ControllerJoystickAreaCm.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("ControllerSettings", "HtcTouchpadClickDeadzone", m_ControllerSettings.m_HtcTouchpadClickDeadzone.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("ControllerSettings", "EnablePlayspaceRecenter", If(m_ControllerSettings.m_EnablePlayspaceRecenter, "true", "false"))

                            mIni.WriteKeyValue("HmdSettings", "UseCustomDistortion", If(m_HmdSettings.m_UseCustomDistortion, "true", "false"))
                            mIni.WriteKeyValue("HmdSettings", "DistortionK0", m_HmdSettings.m_DistortionK0(True).ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("HmdSettings", "DistortionK1", m_HmdSettings.m_DistortionK1(True).ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("HmdSettings", "DistortionScale", m_HmdSettings.m_DistortionScale(True).ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("HmdSettings", "DistortionRedOffset", m_HmdSettings.m_DistortionRedOffset(True).ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("HmdSettings", "DistortionGreenOffset", m_HmdSettings.m_DistortionGreenOffset(True).ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("HmdSettings", "DistortionBlueOffset", m_HmdSettings.m_DistortionBlueOffset(True).ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("HmdSettings", "HFov", m_HmdSettings.m_HFov(True).ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("HmdSettings", "VFov", m_HmdSettings.m_VFov(True).ToString(Globalization.CultureInfo.InvariantCulture))

                            mIni.WriteKeyValue("HmdSettings", "IPD", m_HmdSettings.m_IPD.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("HmdSettings", "RenderScale", m_HmdSettings.m_RenderScale.ToString(Globalization.CultureInfo.InvariantCulture))

                            mIni.WriteKeyValue("HmdSettings", "ViewOffsetX", m_HmdSettings.m_ViewPositionOffset.X.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("HmdSettings", "ViewOffsetY", m_HmdSettings.m_ViewPositionOffset.Y.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("HmdSettings", "ViewOffsetZ", m_HmdSettings.m_ViewPositionOffset.Z.ToString(Globalization.CultureInfo.InvariantCulture))

                            mIni.WriteKeyValue("HmdSettings", "ViewRotOffsetX", m_HmdSettings.m_ViewRotationOffset.X.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("HmdSettings", "ViewRotOffsetY", m_HmdSettings.m_ViewRotationOffset.Y.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("HmdSettings", "ViewRotOffsetZ", m_HmdSettings.m_ViewRotationOffset.Z.ToString(Globalization.CultureInfo.InvariantCulture))

                            mIni.WriteKeyValue("HmdSettings", "HmdPoseOverrideControllerId", CStr(m_HmdSettings.m_HmdPoseOverrideControllerId))
                            mIni.WriteKeyValue("HmdSettings", "HmdPoseOverrideType", CStr(CInt(m_HmdSettings.m_HmdPoseOverrideType)))
                            mIni.WriteKeyValue("HmdSettings", "HmdNoTrackingHeight", m_HmdSettings.m_HmdNoTrackingHeight.ToString(Globalization.CultureInfo.InvariantCulture))

                            mIni.WriteKeyValue("MiscSettings", "DisableBaseStationSpawning", If(g_mMiscSettings.m_DisableBaseStationSpawning, "true", "false"))
                            mIni.WriteKeyValue("MiscSettings", "EnableHepticFeedback", If(g_mMiscSettings.m_EnableHepticFeedback, "true", "false"))
                            mIni.WriteKeyValue("MiscSettings", "OptimizeTransportPackets", If(g_mMiscSettings.m_OptimizeTransportPackets, "true", "false"))
                            mIni.WriteKeyValue("MiscSettings", "RenderWindowFix", If(g_mMiscSettings.m_RenderWindowFix, "true", "false"))
                            mIni.WriteKeyValue("MiscSettings", "EnableVelocityHmd", If(g_mMiscSettings.m_EnableVelocityHmd, "true", "false"))
                            mIni.WriteKeyValue("MiscSettings", "EnableVelocityController", If(g_mMiscSettings.m_EnableVelocityController, "true", "false"))
                            mIni.WriteKeyValue("MiscSettings", "EnableVelocityTracker", If(g_mMiscSettings.m_EnableVelocityTracker, "true", "false"))
                            mIni.WriteKeyValue("MiscSettings", "EnableManualVelocity", If(g_mMiscSettings.m_EnableManualVelocity, "true", "false"))
                            mIni.WriteKeyValue("MiscSettings", "OscRemoteIP", g_mMiscSettings.m_OscRemoteIP)
                        End If
                        ...
                        If ((iSaveFlags And ENUM_SETTINGS_SAVE_TYPE_FLAGS.PLAYSPACE) <> 0 OrElse (iSaveFlags And ENUM_SETTINGS_SAVE_TYPE_FLAGS.ALL) <> 0) Then
                            mIni.WriteKeyValue("PlayspaceSettings", "ForwardOffset", m_PlayspaceSettings.m_ForwardOffset.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("PlayspaceSettings", "SideOffset", m_PlayspaceSettings.m_SideOffset.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("PlayspaceSettings", "HeightOffset", m_PlayspaceSettings.m_HeightOffset.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("PlayspaceSettings", "ForwardMethod", CStr(CInt(m_PlayspaceSettings.m_ForwardMethod)))
                            mIni.WriteKeyValue("PlayspaceSettings", "AutoScale", If(m_PlayspaceSettings.m_AutoScale, "true", "false"))
                        End If
                        ...
                        If ((iSaveFlags And ENUM_SETTINGS_SAVE_TYPE_FLAGS.PLAYSPACE_CALIB_CONTROLLER) <> 0 OrElse (iSaveFlags And ENUM_SETTINGS_SAVE_TYPE_FLAGS.ALL) <> 0) Then
                            mIni.WriteKeyValue("PlayspaceSettings", "CalibControllerId", CStr(m_PlayspaceSettings.m_CalibrationControllerId))
                        End If
                        ...
                        If ((iSaveFlags And ENUM_SETTINGS_SAVE_TYPE_FLAGS.PLAYSPACE_CALIBRATION) <> 0 OrElse (iSaveFlags And ENUM_SETTINGS_SAVE_TYPE_FLAGS.ALL) <> 0) Then
                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "PosOffsetX", m_PlayspaceSettings.m_PosOffset.X.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "PosOffsetY", m_PlayspaceSettings.m_PosOffset.Y.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "PosOffsetZ", m_PlayspaceSettings.m_PosOffset.Z.ToString(Globalization.CultureInfo.InvariantCulture))

                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "AngOffsetX", m_PlayspaceSettings.m_AngOffset.X.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "AngOffsetY", m_PlayspaceSettings.m_AngOffset.Y.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "AngOffsetZ", m_PlayspaceSettings.m_AngOffset.Z.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "AngOffsetW", m_PlayspaceSettings.m_AngOffset.W.ToString(Globalization.CultureInfo.InvariantCulture))

                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "PointControllerBeginPosX", m_PlayspaceSettings.m_PointControllerBeginPos.X.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "PointControllerBeginPosY", m_PlayspaceSettings.m_PointControllerBeginPos.Y.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "PointControllerBeginPosZ", m_PlayspaceSettings.m_PointControllerBeginPos.Z.ToString(Globalization.CultureInfo.InvariantCulture))

                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "PointControllerEndPosX", m_PlayspaceSettings.m_PointControllerEndPos.X.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "PointControllerEndPosY", m_PlayspaceSettings.m_PointControllerEndPos.Y.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "PointControllerEndPosZ", m_PlayspaceSettings.m_PointControllerEndPos.Z.ToString(Globalization.CultureInfo.InvariantCulture))

                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "PointHmdBeginPosX", m_PlayspaceSettings.m_PointHmdBeginPos.X.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "PointHmdBeginPosY", m_PlayspaceSettings.m_PointHmdBeginPos.Y.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "PointHmdBeginPosZ", m_PlayspaceSettings.m_PointHmdBeginPos.Z.ToString(Globalization.CultureInfo.InvariantCulture))

                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "PointHmdEndPosX", m_PlayspaceSettings.m_PointHmdEndPos.X.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "PointHmdEndPosY", m_PlayspaceSettings.m_PointHmdEndPos.Y.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "PointHmdEndPosZ", m_PlayspaceSettings.m_PointHmdEndPos.Z.ToString(Globalization.CultureInfo.InvariantCulture))

                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "HmdAngOffsetX", m_PlayspaceSettings.m_HmdAngOffset.X.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "HmdAngOffsetY", m_PlayspaceSettings.m_HmdAngOffset.Y.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "HmdAngOffsetZ", m_PlayspaceSettings.m_HmdAngOffset.Z.ToString(Globalization.CultureInfo.InvariantCulture))
                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "HmdAngOffsetW", m_PlayspaceSettings.m_HmdAngOffset.W.ToString(Globalization.CultureInfo.InvariantCulture))

                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "ScaleOffset", m_PlayspaceSettings.m_ScaleOffset.ToString(Globalization.CultureInfo.InvariantCulture))

                            mIni.WriteKeyValue("PlayspaceCalibrationSettings", "Valid", If(m_PlayspaceSettings.m_Valid, "true", "false"))
                        End If
                    End Using
                End Using
            End SyncLock
